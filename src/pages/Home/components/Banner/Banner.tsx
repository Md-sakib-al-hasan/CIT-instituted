      ...
      >
        ...
        {images.map((item, index) => (
          ...
          <span className="text-5xl text-white absolute max-w-[1280px] animate-once animate-fade-up top-36  w-11/12 mx-auto   ">
               ...
               <button className="btn uppercase text-md  bg-[#ff4f10] border-none  px-16 hover:bg-white hover:text-[#0b1431] rounded-none text-white "> Join us now! </button>
               ...
               <button className="btn absolute lg:mt-0 mt-10 lg:right-4 text-md btn-outline  capitalize px-10 hover:bg-white hover:text-[#0b1431] rounded-none text-white "> Join us now! </button>
            </span></div>
          </div>
        ))}
      </div>
