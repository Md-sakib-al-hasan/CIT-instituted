...
function ImageCatagory() {
    ...
    const imgelist = [
        ...
        "https://i.ibb.co.com/MPx3fbc/pexels-vince-2363808.jpg",
        "https://i.ibb.co.com/k8tKpZ6/dashbord13.jpg"
    ]
       ...
       <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-11/12 max-w-[1280px]  mx-auto">
         {
            ...
            <img key={id} src={item} alt=""  className="object-cover animate-jump-in animate-once animate-delay-500  xl:h-[400px] h-[400px] lg:h-[300px]  w-full" />
        </div></button>)
         }
       </div>
