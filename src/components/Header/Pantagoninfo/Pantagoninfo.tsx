      ...
      <div style={{ top: pantagoninfo? topPosition: "0px" }} className={`absolute transform transition-all duration-700 left-0 right-0 bg-white border-b-4 border-[#ff4f01] py-10`}>
        ...
        <div className="text-[#131D3B] w-11/12 max-w-[1280px] mx-auto grid grid-cols-3 gap-10">
          ...
          <ul className="space-y-4 font-semibold text-[#666D81]">
            ...
            <li className="justify-between w-full flex capitalize"><span>Monday</span><span>09am-05pm</span></li>
            <li className="justify-between w-full flex capitalize"><span>Tuesday</span><span>09am-05pm</span></li>
            <li className="justify-between w-full flex capitalize"><span>Wednesday</span><span>09am-05pm</span></li>
            <li className="justify-between w-full flex capitalize"><span>Thursday</span><span>09am-05pm</span></li>
            <li className="justify-between w-full flex capitalize"><span>Friday</span><span>09am-05pm</span></li>
            <li className="justify-between w-full flex capitalize"><span>Saturday-Sunday</span><span>Closed</span></li>
          </ul>
          {/* Third column */}
